...
function bvo_special_bonus_lifesteal_5__modifier:IsHidden()
	return true
end

function bvo_special_bonus_lifesteal_5_modifier:DeclareFunctions()
	local funcs = {
...
function bvo_special_bonus_lifesteal_5_modifier_modifier:OnAttackLanded( params )
	if IsServer() then
		local attacker = params.attacker
		if attacker:HasModifier("bvo_special_bonus_lifesteal_5_modifier") then
